"""
Obesity Level Prediction using One-vs-One (OvO) Multiclass Classification
=========================================================================

This module demonstrates how to build a multiclass classification model
to predict obesity levels using the One-vs-One strategy.

Dataset: 
    Obesity level prediction dataset including various health metrics
    
Model: 
    Multiclass classification using One-vs-One Logistic Regression
"""
...
# -------------------------------
print("\nTraining Logistic Regression with One-vs-One strategy...")
...
print(f"One-vs-One (OvO) Strategy Accuracy: {accuracy}%")

# Display model parameters
print("\nNumber of classes:", len(np.unique(y)))
print("Number of binary classifiers:", len(model_ovo.estimators_))

# Save the model
import joblib
joblib.dump(model_ovo, 'obesity_ovo_model.pkl')
print("Model saved as 'obesity_ovo_model.pkl'")